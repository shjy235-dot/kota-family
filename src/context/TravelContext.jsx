  ...
  useEffect(() => {
    const unsubscribe = onSnapshot(docRef, async (docSnap) => {
      if (docSnap.exists()) {
        ...
        const oldSubwayLine810 = "08:10 제셀톤 스퀘어(Jesselton Square) 내 <a href='https://blog.naver.com/happy_24h/224207917387' target='_blank' rel='noreferrer' style='color:var(--ocean-accent); text-decoration:underline; font-weight:600;'>서브웨이</a>에서 점심 테이크아웃 <a href='http://google.com/maps/search/?api=1&query=Subway%20Jesselton%20Square&query_place_id=ChIJddC6zlhpOzIRwxZRauqldgU' target='_blank' rel='noreferrer' style='color:var(--ocean-accent); text-decoration:underline; font-weight:600;'>[지도 보기]</a>";
        const subwayLine = "08:00 제셀톤 스퀘어(Jesselton Square) 내 <a href='https://blog.naver.com/happy_24h/224207917387' target='_blank' rel='noreferrer' style='color:var(--ocean-accent); text-decoration:underline; font-weight:600;'>서브웨이</a>에서 점심 테이크아웃 <a href='http://google.com/maps/search/?api=1&query=Subway%20Jesselton%20Square&query_place_id=ChIJddC6zlhpOzIRwxZRauqldgU' target='_blank' rel='noreferrer' style='color:var(--ocean-accent); text-decoration:underline; font-weight:600;'>[지도 보기]</a>";
        const oldGrabLine0800 = "08:00 그랩 탑승 ➔ 제셀톤 포인트 이동 (약 10분 소요)";
        const oldGrabLine0700 = "07:00 그랩 탑승 ➔ 제셀톤 포인트 이동 (약 10분 소요)";
        const grabLine = "07:50 그랩 탑승 ➔ 제셀톤 포인트 이동 (약 10분 소요)";
        ...
        const itineraryTextPatches = [
          ...
          ["06:10 래시가드 착용 후 파이브 세일링 조식 뷔페 식사", breakfastLine],
          ["08:15 그랩 탑승 ➔ 제셀톤 포인트 이동", grabLine],
          ["08:00 그랩 탑승 ➔ 제셀톤 포인트 이동", grabLine],
          [oldGrabLine0800, grabLine],
          [oldGrabLine0700, grabLine],
