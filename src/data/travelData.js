...
const travelData = {
  ...
  // 메인 홈: 출국 전 필수 체크리스트
  preTripChecklist: [
    { id: 1, task: "말레이시아 디지털 입국카드(MDAC) 사전 등록 (출발 3일 전)", completed: false },
  ...
  itinerary: [
    { day: "Day 1 (8/30 일)", title: "출발 & 주차대행 하차 & 출국", schedule: [
      ...
      "16:00 인천공항 제1터미널 단기주차장 지하 1층(C구역) 공식 주차대행 접수장 하차",
    ...
    { day: "Day 5 (9/3 목)", title: "귀국 및 자택 도착", schedule: [
      ...
      "07:50 단기주차장 지하 1층 주차대행 정산소 이동 (다자녀 할인 정산)",
  ...
  budget: {
    ...
    prePaid: {
      ...
      items: [
        ...
        { name: "주차비", amount: "18,000원", desc: "공항 다자녀 50% 할인 적용 (4일)" }
      ]
    },
    local: {
