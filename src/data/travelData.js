...
const travelData = {
  ...
  hotel: {
    ...
    benefits: [
      ...
      "<span style='display:block; margin-top:8px; padding-top:8px; border-top:1px dashed rgba(0,0,0,0.15);'><strong style='color:var(--ocean-accent);'>호텔이용팁</strong>: 리틀 마젤란에서 <a href='https://kotamania.tistory.com/61' target='_blank' rel='noreferrer' style='color:var(--ocean-accent); text-decoration:underline; font-weight:600;'>꼬마기차</a> 이용 가능</span>",
    ],
    goldCard: {
